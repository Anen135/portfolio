...
const CONTACT_LINKS = [
  ...
  // { icon: <LinkedinIcon />, label: "LinkedIn", value: "linkedin.com/in/you", href: config.linkedin, color: "#0077b5" },
  { icon: <TelegramIcon />, label: "Telegram", value: "@yourusername", href: config.telegram, color: "#2CA5E0" },
];
